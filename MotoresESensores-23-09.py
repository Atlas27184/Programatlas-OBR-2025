...
drive_base = DriveBase(motor_esquerdo, motor_direito, wheel_diameter=5.6, axle_track=14.45)
drive_base.settings(15, 10, 10)
...
def Seguidor_de_Linha(): 
    ...
    while True:
        ...
        # Correção de curvas 
        if (sensor_1.reflection() < 20) and (sensor_2.reflection() < 20) and (sensor_3.reflection() > 20):
            PararMotores()
            drive_base.straight(10)
            hub.speaker.beep(24000 )
            wait(250)
            drive_base.turn(-10)
            if sensor_1.reflection() < 20:
                drive_base.turn(10)

            while not (sensor_3.reflection() < 40):
                motor_esquerdo.run(_70_porcento)
                motor_direito.run(-_40_porcento)
            PararMotores()
            ...
            if sensor_4.reflection() < 20:
                drive_base.turn(-10)
            while not (sensor_2.reflection() < 20):
                motor_esquerdo.run(_70_porcento)
                motor_direito.run(-_40_porcento)
            PararMotores()
        # PID básico
        error = ((60 - sensor_1.reflection()) + (60 - sensor_2.reflection())) - ((60 - sensor_3.reflection()) + (60 - sensor_4.reflection()))
        ...
        if (sensor_1.reflection() > 30) and (sensor_2.reflection() > 70) and (sensor_3.reflection() > 70) and (sensor_4.reflection() > 30):
            correcao = 0
...
def AreaDeResgate():
    ...
    global estado
    while True:
        hub.display.text('Tralalero tralala')
        PararMotores()
#================================================#
'''
