...
def Seguidor_de_Linha(): 
    ...
    while True:
        ...
        if (sensor_1.reflection() < 20) and (sensor_2.reflection() < 20) and not (sensor_3.reflection() < 20):
            DoisMotoresAngulo(velocidade_padrão, 100)
            wait(1000)
            motor_esquerdo.run_angle(-velocidade_padrão, 1)
            motor_direito.run_angle(velocidade_padrão, 1)
        ...
        if (sensor_1.reflection() > 50) and (sensor_2.reflection() > 50) and (sensor_3.reflection() > 50) and (sensor_4.reflection() > 50):
            correcao = 0
